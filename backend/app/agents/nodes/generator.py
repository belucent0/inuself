...
- 동일한 약어/이름이 여러 의미를 가질 수 있습니다 (예: TSMC, Apple, Jaguar 등)
- 검색 결과의 **다수 의견(Majority Consensus)**을 따르세요
- 검색 결과 10개 중 8개가 A를 가리키고 2개가 B를 가리킨다면, A가 정답입니다
- 소수의 결과가 다른 의미를 가리키더라도 무시하고, 다수 결과와 일관성을 유지하세요

**일반적인 약어/개체 의미:**
- TSMC: Taiwan Semiconductor Manufacturing Company (대만 반도체 파운드리)
- Apple: Apple Inc. (미국 IT 기업)
...
**중요: 개체 명확화 (Entity Disambiguation) 원칙**
- 동일한 약어/이름이 여러 의미를 가질 수 있습니다
- 검색 결과와 문서의 **다수 의견(Majority Consensus)**을 따르세요
- 소수의 결과가 다른 의미를 가리키더라도, 다수 결과와 일관성을 유지하세요
