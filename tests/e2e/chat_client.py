...
class ChatClient:
    ...
    async def stream_response(
        ...
        url = f"/api/threads/{thread_id}/messages/{message_id}/stream"
        ...
        async with self._client.stream(
            ...
            async for line in response.aiter_lines():
                ...
                if event_type == "token":
                    ...
                    if isinstance(event_data, dict) and isinstance(event_data.get("content"), str):
